              ...
              <div className="flex md:w-1/2 w-full flex-col gap-3 border border-green-300 rounded-md p-3 bg-green-50">
                ...
                <div className="flex">
                  ...
                  >
                    ...
                    <span className="no-underline font-semibold text-black">
                      Chat ngay
                    </span>
                  </div>
                  {showChat && (
                  ...
                  {/* chat ngay */}
                  <Link
                    className="flex text-sm justify-evenly w-28 px-1.5 py-1.5 bg-primary text-black rounded align-center leading-5 ml-2 hover:bg-green-700"
